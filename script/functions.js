jQuery(document).ready(function($) {
    ...
    jQuery(function() {
        ...
        jQuery('#ezfolio-countdown').countdown({
            until: austDay
        });
    ...
    // Click to Top Button
    //***************************
    jQuery('.ezfolio-back-top').on("click", function() {
    ...
    // banner Function
    //***************************
    jQuery('.ezfolio-banner-one').bxSlider({
      auto: true,
      autoControls: true,
      mode:'fade',
      speed: 500,
    ...
    $( '.main-menu' ).mobileMegaMenu({
        ...
        stayOnActive: true,
        toogleTextOnClose: '<i class="icon-uniF106"></i>',
...
//***************************
    // FilterAble Function
    //***************************
    var $grid = $('.ezfolio-filter-gallery').isotope({
